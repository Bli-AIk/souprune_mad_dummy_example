//! Bootstrapped code asset for `battle/rules/dialogue_test.fre.ron`.
//!
//! `battle/rules/dialogue_test.fre.ron` 的 bootstrap 代码资产。
...
pub fn emit(reg: &mut Registry) -> Result<()> {
    reg.emit_ron("battle/rules/dialogue_test.fre.ron", &asset())?;
    Ok(())
}
